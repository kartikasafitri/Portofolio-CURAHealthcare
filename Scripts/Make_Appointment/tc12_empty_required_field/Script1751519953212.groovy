...
WebUI.selectOptionByValue(new TestObject().addProperty('xpath', ConditionType.EQUALS,"//select[@id='combo_facility']"),'Tokyo CURA Healthcare Center', true)
...
WebUI.setText(new TestObject().addProperty('xpath', ConditionType.EQUALS,"//textarea[@id='txt_comment']"),'')
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS,"//button[@id='btn-book-appointment']"))
WebUI.delay(2)
WebUI.verifyElementNotPresent(new TestObject().addProperty('xpath', ConditionType.EQUALS,"//section[@id='summary']/div/div/div/h2"),0)