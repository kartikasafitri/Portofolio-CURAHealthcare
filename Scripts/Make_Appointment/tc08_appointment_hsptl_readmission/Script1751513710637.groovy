...
WebUI.selectOptionByValue(new TestObject().addProperty('xpath', ConditionType.EQUALS,"//select[@id='combo_facility']"),'Hongkong CURA Healthcare Center', true)
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS,"//input[@id='chk_hospotal_readmission']"))
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS,"//input[@id='radio_program_medicaid']"))
